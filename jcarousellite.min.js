 ...
 *
*/
(function(f){function r(x,a){return parseInt(f.css(x[0],a),10)||0}f.jCarouselLite={version:"1.6.4",curr:0};f.fn.jCarouselLite=function(x){var a=f.extend({},f.fn.jCarouselLite.defaults,x);this.each(function(){function y(){return i.slice(e).slice(0,g)}function n(c){if(z)return false;var b=c>e;a.beforeStart&&a.beforeStart.call(this,y(),b);if(a.circular)if(c<=l-g-1){m.css(s,-((j-g*2)*o)+"px");e=c==l-g-1?j-g*2-1:j-g*2-a.scroll}else if(c>=j-g+1){m.css(s,-(g*o)+"px");e=c==j-g+1?g+1:g+a.scroll}else e=c;else e=
